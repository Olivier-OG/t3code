...
// Canonical form is a bare `<8 hex>` token. Branches created before this fork
// dropped the prefix carry `t3code/`, and older mobile builds generated a
// `<uuid>` via Crypto.randomUUID() (always RFC 4122 v4), so the matcher accepts
// exactly those shapes too — version nibble `4`, variant nibble `[89ab]` — to

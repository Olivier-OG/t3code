...
| Runtime mode        | The thread's permission policy. This fork withdraws `full-access`: the literal still decodes, as `auto`. See [permission modes](../user/permission-modes.md). |
